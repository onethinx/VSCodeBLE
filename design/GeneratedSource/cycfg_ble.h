...
#define CY_BLE_GATT_DB_MAX_VALUE_LEN                (0x000Eu)
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x0027u)
...
#define CY_BLE_GATT_DB_ATT_VAL_COUNT                (0x2Fu)
...
<Configuration major="1" minor="0">
            ...
            <ProfileRoles>
                <ProfileRole type="Server">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{b0e2427a-0b33-446d-a819-f49351a6bbc6}"/>
                                    ...
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="Fine Me Target"/>
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{29a1d8dc-0963-4bff-a3b7-f8b2ad408331}"/>
                                <Property id="Name" value="Generic Attribute"/>
                                <Property id="DisplayName" value="Generic Attribute"/>
                                <Property id="UUID" value="1801"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                                <Property id="IncludedServices" value="{a01edafb-3d91-462f-babb-118e8f3630df}, {c0a1bf77-6181-461d-96e6-f6521924e92e}"/>
                            </ServiceProperties>
                            <Characteristics>
                        ...
                        <Service type="org.bluetooth.service.immediate_alert">
                            <ServiceProperties>
                                <Property id="EntityID" value="{a01edafb-3d91-462f-babb-118e8f3630df}"/>
                        ...
                        <Service type="org.bluetooth.service.device_information">
                            <ServiceProperties>
                                <Property id="EntityID" value="{c0a1bf77-6181-461d-96e6-f6521924e92e}"/>
                ...
                <ProfileRole type="Client">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{c2f3d4e3-d002-43b1-91e9-ad76699f1ce5}"/>
                                <Property id="Name" value="Generic Access"/>
                                <Property id="DisplayName" value="Generic Access"/>
                                <Property id="UUID" value="1800"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{2c0b0b16-17ba-492b-b78e-705f62a54188}"/>
                                <Property id="Name" value="Generic Attribute"/>
                                <Property id="DisplayName" value="Generic Attribute"/>
                                <Property id="UUID" value="1801"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
    ...
    <GAP>
        <General>
            ...
            <Property id="DeviceName" value="Fine Me Target"/>
        ...
        <PeripheralConfigurations>
            <PeripheralConfiguration name="Peripheral configuration 0">
                ...
                <AdvertisementPacket>
                    ...
                    <Property id="ServiceUuid" value="{a01edafb-3d91-462f-babb-118e8f3630df}, {c0a1bf77-6181-461d-96e6-f6521924e92e}"/>
