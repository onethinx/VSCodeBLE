...
{
    cy_en_ble_eco_status_t status = Cy_BLE_EcoConfigure(CY_BLE_BLESS_ECO_FREQ_32MHZ, CY_BLE_SYS_ECO_CLK_DIV_4, 25U, 32U, CY_BLE_ECO_VOLTAGE_REG_AUTO);
...
{
    Cy_SysClk_ClkFastSetDivider(1U);
}
